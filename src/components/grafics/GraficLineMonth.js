...
export const GraficLineMonth = ({ data, label, dtsetbg, optionbg, scalebg, title, labelop, legendbg = 'black', sexo = null, lineColor = "#5BCDFA", scltxtlbl = "Cantidad de vehículos", pl = 0, pr = 0, pb = 0, pt = 0 }) => {
        ...
        <>
            {data.length === 0 ?
                ...
                (
                    <Line data={
                        {
                            labels: data.map(a => a.day.substring(0, 2)),
                            datasets: [
                                {
                                    label: `${label}`,
